          ...
          <?php }else{ ?>
              ...
              <li class="nav-item
                <?php
                    			 ...
                    			 ?>">
                <a class="nav-link" href="login.php?loginType=3"><i class="fas fa-sign-in-alt mr-2"></i>Login</a>
              </li>
              ...
              <li class="nav-item
                <?php
                    			 ...
                    			 ?>">
                <a class="nav-link" href="login.php?loginType=1"><i class="fas fa-sign-in-alt mr-2"></i>Admin Login</a>
              </li>
